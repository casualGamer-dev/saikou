...
import ani.animebinge.anilist.AnilistHomeViewModel
import ani.animebinge.anilist.getUserId
import ani.animebinge.databinding.FragmentHomeBinding
import ani.animebinge.media.Media
import ani.animebinge.media.MediaAdaptor
import ani.animebinge.settings.SettingsDialogFragment
import ani.animebinge.settings.UserInterfaceSettings
import ani.animebinge.user.ListActivity
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        model.empty.observe(viewLifecycleOwner) {
            binding.homeanimebingeContainer.visibility = if (it == true) View.VISIBLE else View.GONE
            (binding.homeanimebingeIcon.drawable as Animatable).start()
            binding.homeanimebingeContainer.startAnimation(setSlideUp(uiSettings))
            binding.homeanimebingeIcon.setSafeOnClickListener {
                (binding.homeanimebingeIcon.drawable as Animatable).start()
            }
        }
