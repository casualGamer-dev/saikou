...
import ani.animebinge.databinding.ActivitySettingsBinding
import ani.animebinge.others.CustomBottomDialog
...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.settingsVersion.setOnLongClickListener {
            ...
            val info = """
animebinge Version: ${BuildConfig.VERSION_NAME}
Device: $BRAND $DEVICE
...
OS Version: $CODENAME $RELEASE ($SDK_INT)
        ...
        binding.settingUPI.setOnClickListener {
            val upi = "upi://pay?pa=brahmkshatriya@apl&pn=animebinge"
