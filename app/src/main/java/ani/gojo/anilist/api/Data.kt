...
class Query{
    ...
    data class Viewer(
        ...
        data class Data(
            @SerialName("Viewer")
            val user: ani.gojo.anilist.api.User?
        )
    }
    @Serializable
    data class Media(
        ...
        data class Data(
            @SerialName("Media")
            val media: ani.gojo.anilist.api.Media?
        )
    }
    ...
    data class Page(
        ...
        data class Data(
            @SerialName("Page")
            val page : ani.gojo.anilist.api.Page?
        )
    }
...
//    ){
//        data class Data(
//            val AiringSchedule: ani.gojo.anilist.api.AiringSchedule?
//        )
//    }
    ...
    data class Character(
        ...
        data class Data(
            ...
            val character: ani.gojo.anilist.api.Character?
        )
    }
    ...
    data class Studio(
        ...
        data class Data(
            @SerialName("Studio")
            val studio: ani.gojo.anilist.api.Studio?
        )
    }
...
//    ){
//        data class Data(
//            val MediaList: ani.gojo.anilist.api.MediaList?
//        )
//    }
    ...
    data class MediaListCollection(
        ...
        data class Data(
            ...
            val mediaListCollection: ani.gojo.anilist.api.MediaListCollection?
        )
    }
