package ani.gojo.manga.mangareader
...
import ani.gojo.databinding.ActivityMangaReaderBinding
import ani.gojo.manga.MangaChapter
import ani.gojo.media.Media
import ani.gojo.media.MediaDetailsViewModel
import ani.gojo.others.ImageViewDialog
import ani.gojo.parsers.HMangaSources
import ani.gojo.parsers.MangaImage
import ani.gojo.parsers.MangaSources
import ani.gojo.settings.CurrentReaderSettings.Companion.applyWebtoon
import ani.gojo.settings.CurrentReaderSettings.Directions.*
import ani.gojo.settings.CurrentReaderSettings.DualPageModes.*
import ani.gojo.settings.CurrentReaderSettings.Layouts.CONTINUOUS_PAGED
import ani.gojo.settings.CurrentReaderSettings.Layouts.PAGED
import ani.gojo.settings.ReaderSettings
import ani.gojo.settings.UserInterfaceSettings
