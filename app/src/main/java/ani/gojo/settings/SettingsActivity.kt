...
import ani.gojo.*
import ani.gojo.databinding.ActivitySettingsBinding
import ani.gojo.others.CustomBottomDialog
...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.settingsVersion.setOnLongClickListener {
            ...
            val info = """
gojo Version: ${BuildConfig.VERSION_NAME}
Device: $BRAND $DEVICE
...
OS Version: $CODENAME $RELEASE ($SDK_INT)
        ...
        binding.settingUPI.setOnClickListener {
            val upi = "upi://pay?pa=brahmkshatriya@apl&pn=gojo"
