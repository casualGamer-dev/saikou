...
import ani.gojo.anilist.AnilistHomeViewModel
import ani.gojo.anilist.getUserId
import ani.gojo.databinding.FragmentHomeBinding
import ani.gojo.media.Media
import ani.gojo.media.MediaAdaptor
import ani.gojo.settings.SettingsDialogFragment
import ani.gojo.settings.UserInterfaceSettings
import ani.gojo.user.ListActivity
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        model.empty.observe(viewLifecycleOwner) {
            binding.homegojoContainer.visibility = if (it == true) View.VISIBLE else View.GONE
            (binding.homegojoIcon.drawable as Animatable).start()
            binding.homegojoContainer.startAnimation(setSlideUp(uiSettings))
            binding.homegojoIcon.setSafeOnClickListener {
                (binding.homegojoIcon.drawable as Animatable).start()
            }
        }
